...
<ul class="menuSuperior">
	...
	<li class="selected"><a href="candidato.php">Candidatos</a>
...
<input type="text"     name="telefone" pattern="[0-9]{2}-[0-9]{4}-[0-9]{4}" value="  seu telefone xx-xxxx-xxxx " 
id="seutelefone" required>
<input type="text"     name="cpf" value="seu cpf 000.000.000/00" id="seucpf" pattern="[0-9]{3}.[0-9]{3}.[0-9]{3}\/[0-9]{2}" required>
<input type="text"     name="idt" value="sua identidade 00000000-0" id="orgaoemissor" pattern="[0-9]{8}-[0-9]{1}" required>
...
<input type="email"    name="email" value="seu e-mail" required id="seuusuario">
<input type="password" name="senha" value="sua senha" required id="suasenha">
<input type="text"     name="cep" value="seu cep 00000-000" pattern="[0-9]{5}-[0-9]{3}" required id="seucep">

<input type="submit"   name="cadastrar" value="Cadastrar seu dados" id="btncadastrarseusdados">
...
<?php		$nome           = $_POST['nome'];
	   ...
	   if( empty($_POST['nome']) || empty($_POST['datanascimento']) || empty($_POST['estadocivil']) || 
	   empty($_POST['telefone']) || empty($_POST['cpf']) || empty($_POST['idt']) || empty($_POST['rua']) || 
	   empty($_POST['bairro']) || empty($_POST['cidade']) || empty($_POST['estado']) || empty($_POST['email']) || 
	   empty($_POST['senha']) || empty($_POST['cep'] )){
		       echo'Preencha todos os campos!';
	   }//fim if empty
	   else{			
		   $inserir = mysql_query("INSERT INTO `candidatos`(`nome`,`datanascimento`,`estadocivil`,`telefone`,`cpf`,`idt`,`rua`,`bairro`,
		   						  `cidade`,`estado`,`email`,`senha`,`cep`) 
	                              VALUES ('$nome','$datanascimento','$estadocivil','$telefone','$cpf','$idt','$rua','$bairro','$cidade',
								  '$estado','$email','$senha','$cep')");	
					echo"<script language=javascript> alert(\"Cadastro realizado com Sucesso!\");</script>";
	 
	   }
	   	?>
        <!--Ao preencher este formulário você estará concordando com nossos 
        <a title="Termo de Uso" href="termodeuso.html" rel="shadowbox"><input type="radio">Termos de Uso do Site</a>-->
</form>
</section>
</nav>
</header>
...
<nav id="menuinterior">
<h2>Preencha seu Currículo Abaixo</h2>
</nav>
<!--resultado da bsuca do site-->
<section id="formularioCadastroCurriculo">
<!--formulário de cadastro com banco de dados-->
<form id="CadastroCurriculo" method="post" action="#">
<fieldset id="curriculo">
<legend>Cadastrar seu currículo:</legend>
<div id="sobrevoce">
<textarea name="objetivosProfissionais" id="objprofissional" required>seu obejtivo profissional</textarea>
<textarea  name="cursosExtracurriculares"  id="curosextra" required>cursos extra-curriculares</textarea>
</div>
<div id="sobrevoce">
<textarea  name="experienciaProfissional" id="expprofi" required>experiência profissional</textarea>
<textarea name="formacaoAcademica"  id="formacademy" required>sua formação acadêmica</textarea>
</div>
<div id="sobrevoce">
<textarea name="digaSobre" required id="digaSobre">fale sobre você</textarea>
<span class="profissoes">
<select name="cargodeInteresse">
...
<span class="idiomas">
 <select name="idiomas" id="idiomas">
    <option value="">Selecione língua estrangeira</option>
    <option value="ingles">Inglês</option>
    <option value="espanhol">Espanhol</option>
  </select>
  </span>
 <span id="idiomas">
 <input type="text" name="telefone" pattern="[0-9]{2}-[0-9]{4}-[0-9]{4}" value="seu telefone xx-xxxx-xxxx " id="grambel" 
 required>
 </span> 
...
<div id="sobrevoce">
 ...
 <span class="deficiencia"><textarea name="tipoDeficiencia">Tem alguma deficiência? Descreva qual.</textarea></span>
  <span class="informacoesComplementares"><textarea name="informacoesComplementares">Informações Complementares
  </textarea></span>
...
<div id="sobrevoce">
 ...
 <span class="deficiencia"></span>
<input type="submit" name="btncurriculo" value="Cadastrar seu currículo" id="btncadastrarseusdados">
<input type="reset" name="btnlimpar" value="Limpar formulário" id="btnlimparseusdados">
...
<?php 
  	$objetivosProfissional              = $_POST['objetivosProfissionais'];
	$cursosExtracurriculares           = $_POST['cursosExtracurriculares'];
	$experienciaProfissional           = $_POST['experienciaProfissional'];
	$formacaoAcademica                 = $_POST['formacaoAcademica'];
	$digaSobre                         = $_POST['digaSobre'];
	...
	if($_POST['btncurriculo']){
	
	   mysql_query("INSERT INTO `curriculo`( 
			 `objetivosProfissionais`,`cursosExtracurriculares`,`experienciaProfissional`,`formacaoAcademica`,`cargodeInteresse`,
			 `idiomas`,`telefone`,`estado`,`tipoDeficiencia`,`informacoesComplementares`,`digaSobre`)
	 
     VALUES ('$objetivosProfissionais ','$cursosExtracurriculares','$experienciaProfissional','$formacaoAcademica',
	 '$cargodeInteresse ','$idiomas','$telefone','$estado','$tipoDeficiencia','$informacoesComplementares','$digaSobre')");
	 	echo"<script language=javascript> alert(\"Cadastro realizado com Sucesso!\");</script>";
	}
...
<a title="Histórias de Sucesso" href="videos/video2.mp4" rel="shadowbox,width=600;height=400" target="_blank"><img src="videos/capa.jpg"></a></section>
<!--rodapé do site-->
<footer>
